...
type Report struct {
	...
	TargetType     string                 `protobuf:"bytes,3,opt,name=target_type,json=targetType,proto3" json:"target_type,omitempty"` // user | deck
	...
	Status         string                 `protobuf:"bytes,7,opt,name=status,proto3" json:"status,omitempty"` // pending | resolved | dismissed
	AdminNote      string                 `protobuf:"bytes,8,opt,name=admin_note,json=adminNote,proto3" json:"admin_note,omitempty"`
	Resolution     string                 `protobuf:"bytes,9,opt,name=resolution,proto3" json:"resolution,omitempty"` // banned | deck_hidden | deck_deleted | "" (when dismissed)
...
type ListReportsRequest struct {
	...
	StatusFilter  string                 `protobuf:"bytes,3,opt,name=status_filter,json=statusFilter,proto3" json:"status_filter,omitempty"` // "", pending, resolved, dismissed
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ProcessReportRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ReportId      string                 `protobuf:"bytes,1,opt,name=report_id,json=reportId,proto3" json:"report_id,omitempty"`
	Action        string                 `protobuf:"bytes,2,opt,name=action,proto3" json:"action,omitempty"` // ban_user | hide_deck | delete_deck | dismiss
...
type ProcessReportResponse struct {
	...
	AffectedReports   int32                  `protobuf:"varint,2,opt,name=affected_reports,json=affectedReports,proto3" json:"affected_reports,omitempty"`       // total reports bulk-resolved for the same target
	NotifiedReporters int32                  `protobuf:"varint,3,opt,name=notified_reporters,json=notifiedReporters,proto3" json:"notified_reporters,omitempty"` // unique reporters notified
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ProcessReportResponse) GetAffectedReports() int32 {
	if x != nil {
		return x.AffectedReports
	}
	return 0
}

func (x *ProcessReportResponse) GetNotifiedReporters() int32 {
	if x != nil {
		return x.NotifiedReporters
	}
	return 0
}
...
func (x *AdminDeck) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdminDeck) ProtoMessage() {}

func (x *AdminDeck) ProtoReflect() protoreflect.Message {
	mi := &file_admin_service_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdminDeck.ProtoReflect.Descriptor instead.
func (*AdminDeck) Descriptor() ([]byte, []int) {
	return file_admin_service_proto_rawDescGZIP(), []int{12}
}

func (x *AdminDeck) GetDeckId() string {
	if x != nil {
		return x.DeckId
	}
	return ""
...
func (x *AdminDeck) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *AdminDeck) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AdminDeck) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *AdminDeck) GetIsPublic() bool {
	if x != nil {
		return x.IsPublic
	}
	return false
...
func (x *AdminDeck) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *AdminDeck) GetCardCount() int32 {
	if x != nil {
		return x.CardCount
	}
	return 0
...
func (x *AdminDeck) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *AdminDeck) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
func (x *ListDecksRequest) GetStatusFilter() string {
	if x != nil {
		return x.StatusFilter
	}
	return ""
...
type ListDecksResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Decks         []*AdminDeck           `protobuf:"bytes,1,rep,name=decks,proto3" json:"decks,omitempty"`
	NextPageToken string                 `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
...
func (x *ListDecksResponse) GetDecks() []*AdminDeck {
	if x != nil {
		return x.Decks
	}
	return nil
...
const file_admin_service_proto_rawDesc = "" +
	"\n" +
	"\x13admin_service.proto\x12\x05admin\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xa6\x03\n" +
	"\x06Report\x12\x1b\n" +
	...
	"\n" +
	"admin_note\x18\b \x01(\tR\tadminNote\x12\x1e\n" +
	"\n" +
	...
	"\n" +
	"admin_note\x18\x03 \x01(\tR\tadminNote\"\x98\x01\n" +
	"\x15ProcessReportResponse\x12%\n" +
	"\x06report\x18\x01 \x01(\v2\r.admin.ReportR\x06report\x12)\n" +
	"\x10affected_reports\x18\x02 \x01(\x05R\x0faffectedReports\x12-\n" +
	"\x12notified_reporters\x18\x03 \x01(\x05R\x11notifiedReporters\"\x84\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\adeck_id\x18\x01 \x01(\tR\x06deckId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"\x85\x02\n" +
	"\tAdminDeck\x12\x17\n" +
	...
	"\x05decks\x18\x01 \x03(\v2\x10.admin.AdminDeckR\x05decks\x12&\n" +
	...
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00\x82\xd3\xe4\x93\x02\":\x01*2\x1d/v1/admin/users/{user_id}/ban\x12\x9e\x01\n" +
	"\tListDecks\x12\x17.admin.ListDecksRequest\x1a\x18.admin.ListDecksResponse\"^\x92AD\n" +
	"\x05admin\x12)[Admin] List all decks (filter by status)b\x10\n" +
	"\x0e\n" +
	"\n" +
	"BearerAuth\x12\x00\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/admin/decks\x12\xdc\x01\n" +
	"\x10UpdateDeckStatus\x12\x1e.admin.UpdateDeckStatusRequest\x1a\x1f.admin.UpdateDeckStatusResponse\"\x86\x01\x92AX\n" +
	"\x05admin\x12=[Admin] Hide or delete the offending deck (cascades to cards)b\x10\n" +
	"\x0e\n" +
	"\n" +
...
var file_admin_service_proto_goTypes = []any{
	...
	(*AdminDeck)(nil),                    // 12: admin.AdminDeck
	(*ListDecksRequest)(nil),             // 13: admin.ListDecksRequest
	(*ListDecksResponse)(nil),            // 14: admin.ListDecksResponse
	(*PromoteModeratorRequest)(nil),      // 15: admin.PromoteModeratorRequest
	(*PromoteModeratorResponse)(nil),     // 16: admin.PromoteModeratorResponse
	(*EmailTemplate)(nil),                // 17: admin.EmailTemplate
	(*ListEmailTemplatesRequest)(nil),    // 18: admin.ListEmailTemplatesRequest
	(*ListEmailTemplatesResponse)(nil),   // 19: admin.ListEmailTemplatesResponse
	(*GetEmailTemplateRequest)(nil),      // 20: admin.GetEmailTemplateRequest
	(*UpdateEmailTemplateRequest)(nil),   // 21: admin.UpdateEmailTemplateRequest
	(*PreviewEmailTemplateRequest)(nil),  // 22: admin.PreviewEmailTemplateRequest
