...
func main() {
	...
	go runGRPCServer(cfg, gapiServer, slogger)
	go runHTTPGateway(cfg, gapiServer, slogger)
...
func runHTTPGateway(cfg config.Config, gapiServer *gapi.Server, logger *slog.Logger) {
